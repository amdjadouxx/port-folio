          ...
          <div className="lg:w-1/2">
            ...
            >
                  ...
                  >
                    ...
                    <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700">
                      ...
                      <p className="text-gray-600 dark:text-gray-300">
                        Formation d&apos;expert en technologies de l&apos;information.
                      </p>
              ...
              <motion.div
                ...
                className="mt-8 p-6 bg-gradient-to-r from-blue-500 to-indigo-600 rounded-xl shadow-lg"
              >
                <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                  <div className="text-white">
                    <h3 className="text-xl font-bold mb-2">📝 Ce parcours n&apos;est pas à jour !</h3>
                    <p className="text-blue-100">
                      Consultez mon profil LinkedIn complet pour découvrir mes dernières expériences professionnelles et projets.
                    </p>
                  </div>
                  <a 
                    href="https://www.linkedin.com/in/amdjad-ahmod-ali-92023b258/" 
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="px-6 py-3 bg-white text-blue-600 font-bold rounded-full transform transition-all duration-300 hover:scale-105 hover:shadow-xl flex items-center gap-2 whitespace-nowrap"
                  >
